...
wp-cli --allow-root --path=/www/wordpress user create user1 user1@test.com --role=editor --user_pass=editor
wp-cli --allow-root --path=/www/wordpress user create user2 user2@test.com --role=editor --user_pass=editor
wp-cli --allow-root --path=/www/wordpress user create user3 user3@test.com --role=editor --user_pass=editor
